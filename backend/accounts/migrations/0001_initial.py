    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_effect', models.CharField(choices=[('happy', 'Happy'), ('surprised', 'Surprised'), ('bop', 'Head bop')], default='happy', max_length=16)),
                ('theme', models.CharField(default='dark', max_length=8)),
                ('accent_color', models.CharField(default='purple', max_length=16)),
